 ...
 *
 * @license MIT
 */function Lo(){return Lo=Object.assign?Object.assign.bind():function(t){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(t[r]=n[r])}return t},Lo.apply(this,arguments)}const dp=I.createContext(null),LT=I.createContext(null),Ar=I.createContext(null),Wu=I.createContext(null),Rr=I.createContext({outlet:null,matches:[],isDataRoute:!1}),T2=I.createContext(null);function MT(t,e){let{relative:n}=e===void 0?{}:e;ys()||Ie(!1);let{basename:r,navigator:i}=I.useContext(Ar),{hash:s,pathname:o,search:l}=A2(t,{relative:n}),a=o;return r!=="/"&&(a=o==="/"?r:pr([r,o])),i.createHref({pathname:a,search:l,hash:s})}function ys(){return I.useContext(Wu)!=null}function ul(){return ys()||Ie(!1),I.useContext(Wu).location}function k2(t){I.useContext(Ar).static||I.useLayoutEffect(t)}function Gu(){let{isDataRoute:t}=I.useContext(Rr);return t?qT():bT()}function bT(){ys()||Ie(!1);let t=I.useContext(dp),{basename:e,future:n,navigator:r}=I.useContext(Ar),{matches:i}=I.useContext(Rr),{pathname:s}=ul(),o=JSON.stringify(cp(i,n.v7_relativeSplatPath)),l=I.useRef(!1);return k2(()=>{l.current=!0}),I.useCallback(function(u,h){if(h===void 0&&(h={}),!l.current)return;if(typeof u=="number"){r.go(u);return}let c=hp(u,JSON.parse(o),s,h.relative==="path");t==null&&e!=="/"&&(c.pathname=c.pathname==="/"?e:pr([e,c.pathname])),(h.replace?r.replace:r.push)(c,h.state,h)},[e,r,o,s,t])}function A2(t,e){let{relative:n}=e===void 0?{}:e,{future:r}=I.useContext(Ar),{matches:i}=I.useContext(Rr),{pathname:s}=ul(),o=JSON.stringify(cp(i,r.v7_relativeSplatPath));return I.useMemo(()=>hp(t,JSON.parse(o),s,n==="path"),[t,o,s,n])}function FT(t,e){return UT(t,e)}function UT(t,e,n,r){ys()||Ie(!1);let{navigator:i}=I.useContext(Ar),{matches:s}=I.useContext(Rr),o=s[s.length-1],l=o?o.params:{};o&&o.pathname;let a=o?o.pathnameBase:"/";o&&o.route;let u=ul(),h;if(e){var c;let T=typeof e=="string"?vs(e):e;a==="/"||(c=T.pathname)!=null&&c.startsWith(a)||Ie(!1),h=T}else h=u;let d=h.pathname||"/",g=d;if(a!=="/"){let T=a.replace(/^\//,"").split("/");g="/"+d.replace(/^\//,"").split("/").slice(T.length).join("/")}let m=dT(t,{pathname:g}),w=zT(m&&m.map(T=>Object.assign({},T,{params:Object.assign({},l,T.params),pathname:pr([a,i.encodeLocation?i.encodeLocation(T.pathname).pathname:T.pathname]),pathnameBase:T.pathnameBase==="/"?a:pr([a,i.encodeLocation?i.encodeLocation(T.pathnameBase).pathname:T.pathnameBase])})),s,n,r);return e&&w?I.createElement(Wu.Provider,{value:{location:Lo({pathname:"/",search:"",hash:"",state:null,key:"default"},h),navigationType:ir.Pop}},w):w}function jT(){let t=KT(),e=OT(t)?t.status+" "+t.statusText:t instanceof Error?t.message:JSON.stringify(t),n=t instanceof Error?t.stack:null,i={padding:"0.5rem",backgroundColor:"rgba(200,200,200, 0.5)"};return I.createElement(I.Fragment,null,I.createElement("h2",null,"Unexpected Application Error!"),I.createElement("h3",{style:{fontStyle:"italic"}},e),n?I.createElement("pre",{style:i},n):null,null)}const $T=I.createElement(jT,null);class VT extends I.Component{constructor(e){super(e),this.state={location:e.location,revalidation:e.revalidation,error:e.error}}static getDerivedStateFromError(e){return{error:e}}static getDerivedStateFromProps(e,n){return n.location!==e.location||n.revalidation!=="idle"&&e.revalidation==="idle"?{error:e.error,location:e.location,revalidation:e.revalidation}:{error:e.error!==void 0?e.error:n.error,location:n.location,revalidation:e.revalidation||n.revalidation}}componentDidCatch(e,n){console.error("React Router caught the following error during render",e,n)}render(){return this.state.error!==void 0?I.createElement(Rr.Provider,{value:this.props.routeContext},I.createElement(T2.Provider,{value:this.state.error,children:this.props.component})):this.props.children}}function BT(t){let{routeContext:e,match:n,children:r}=t,i=I.useContext(dp);return i&&i.static&&i.staticContext&&(n.route.errorElement||n.route.ErrorBoundary)&&(i.staticContext._deepestRenderedBoundaryId=n.route.id),I.createElement(Rr.Provider,{value:e},r)}function zT(t,e,n,r){var i;if(e===void 0&&(e=[]),n===void 0&&(n=null),r===void 0&&(r=null),t==null){var s;if((s=n)!=null&&s.errors)t=n.matches;else return null}let o=t,l=(i=n)==null?void 0:i.errors;if(l!=null){let h=o.findIndex(c=>c.route.id&&(l==null?void 0:l[c.route.id]));h>=0||Ie(!1),o=o.slice(0,Math.min(o.length,h+1))}let a=!1,u=-1;if(n&&r&&r.v7_partialHydration)for(let h=0;h<o.length;h++){let c=o[h];if((c.route.HydrateFallback||c.route.hydrateFallbackElement)&&(u=h),c.route.id){let{loaderData:d,errors:g}=n,m=c.route.loader&&d[c.route.id]===void 0&&(!g||g[c.route.id]===void 0);if(c.route.lazy||m){a=!0,u>=0?o=o.slice(0,u+1):o=[o[0]];break}}}return o.reduceRight((h,c,d)=>{let g,m=!1,w=null,T=null;n&&(g=l&&c.route.id?l[c.route.id]:void 0,w=c.route.errorElement||$T,a&&(u<0&&d===0?(YT("route-fallback",!1),m=!0,T=null):u===d&&(m=!0,T=c.route.hydrateFallbackElement||null)));let p=e.concat(o.slice(0,d+1)),f=()=>{let v;return g?v=w:m?v=T:c.route.Component?v=I.createElement(c.route.Component,null):c.route.element?v=c.route.element:v=h,I.createElement(BT,{match:c,routeContext:{outlet:h,matches:p,isDataRoute:n!=null},children:v})};return n&&(c.route.ErrorBoundary||c.route.errorElement||d===0)?I.createElement(VT,{location:n.location,revalidation:n.revalidation,component:w,error:g,children:f(),routeContext:{outlet:null,matches:p,isDataRoute:!0}}):f()},null)}var R2=function(t){return t.UseBlocker="useBlocker",t.UseRevalidator="useRevalidator",t.UseNavigateStable="useNavigate",t}(R2||{}),Ga=function(t){return t.UseBlocker="useBlocker",t.UseLoaderData="useLoaderData",t.UseActionData="useActionData",t.UseRouteError="useRouteError",t.UseNavigation="useNavigation",t.UseRouteLoaderData="useRouteLoaderData",t.UseMatches="useMatches",t.UseRevalidator="useRevalidator",t.UseNavigateStable="useNavigate",t.UseRouteId="useRouteId",t}(Ga||{});function HT(t){let e=I.useContext(dp);return e||Ie(!1),e}function WT(t){let e=I.useContext(LT);return e||Ie(!1),e}function GT(t){let e=I.useContext(Rr);return e||Ie(!1),e}function N2(t){let e=GT(),n=e.matches[e.matches.length-1];return n.route.id||Ie(!1),n.route.id}function KT(){var t;let e=I.useContext(T2),n=WT(Ga.UseRouteError),r=N2(Ga.UseRouteError);return e!==void 0?e:(t=n.errors)==null?void 0:t[r]}function qT(){let{router:t}=HT(R2.UseNavigateStable),e=N2(Ga.UseNavigateStable),n=I.useRef(!1);return k2(()=>{n.current=!0}),I.useCallback(function(i,s){s===void 0&&(s={}),n.current&&(typeof i=="number"?t.navigate(i):t.navigate(i,Lo({fromRouteId:e},s)))},[t,e])}const l0={};function YT(t,e,n){!e&&!l0[t]&&(l0[t]=!0)}function QT(t){let{to:e,replace:n,state:r,relative:i}=t;ys()||Ie(!1);let{future:s,static:o}=I.useContext(Ar),{matches:l}=I.useContext(Rr),{pathname:a}=ul(),u=Gu(),h=hp(e,cp(l,s.v7_relativeSplatPath),a,i==="path"),c=JSON.stringify(h);return I.useEffect(()=>u(JSON.parse(c),{replace:n,state:r,relative:i}),[u,c,i,n,r]),null}function qs(t){Ie(!1)}function JT(t){let{basename:e="/",children:n=null,location:r,navigationType:i=ir.Pop,navigator:s,static:o=!1,future:l}=t;ys()&&Ie(!1);let a=e.replace(/^\/*/,"/"),u=I.useMemo(()=>({basename:a,navigator:s,static:o,future:Lo({v7_relativeSplatPath:!1},l)}),[a,l,s,o]);typeof r=="string"&&(r=vs(r));let{pathname:h="/",search:c="",hash:d="",state:g=null,key:m="default"}=r,w=I.useMemo(()=>{let T=up(h,a);return T==null?null:{location:{pathname:T,search:c,hash:d,state:g,key:m},navigationType:i}},[a,h,c,d,g,m,i]);return w==null?null:I.createElement(Ar.Provider,{value:u},I.createElement(Wu.Provider,{children:n,value:w}))}function XT(t){let{children:e,location:n}=t;return FT(Rd(e),n)}new Promise(()=>{});function Rd(t,e){e===void 0&&(e=[]);let n=[];return I.Children.forEach(t,(r,i)=>{if(!I.isValidElement(r))return;let s=[...e,i];if(r.type===I.Fragment){n.push.apply(n,Rd(r.props.children,s));return}r.type!==qs&&Ie(!1),!r.props.index||!r.props.children||Ie(!1);let o={id:r.props.id||s.join("-"),caseSensitive:r.props.caseSensitive,element:r.props.element,Component:r.props.Component,index:r.props.index,path:r.props.path,loader:r.props.loader,action:r.props.action,errorElement:r.props.errorElement,ErrorBoundary:r.props.ErrorBoundary,hasErrorBoundary:r.props.ErrorBoundary!=null||r.props.errorElement!=null,shouldRevalidate:r.props.shouldRevalidate,handle:r.props.handle,lazy:r.props.lazy};r.props.children&&(o.children=Rd(r.props.children,s)),n.push(o)}),n}/**
 ...
 *
 * @license MIT
 */function Nd(){return Nd=Object.assign?Object.assign.bind():function(t){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(t[r]=n[r])}return t},Nd.apply(this,arguments)}function ZT(t,e){if(t==null)return{};var n={},r=Object.keys(t),i,s;for(s=0;s<r.length;s++)i=r[s],!(e.indexOf(i)>=0)&&(n[i]=t[i]);return n}function ek(t){return!!(t.metaKey||t.altKey||t.ctrlKey||t.shiftKey)}function tk(t,e){return t.button===0&&(!e||e==="_self")&&!ek(t)}const nk=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset","unstable_viewTransition"],rk="6";try{window.__reactRouterVersion=rk}catch{}const ik="startTransition",a0=YC[ik];function sk(t){let{basename:e,children:n,future:r,window:i}=t,s=I.useRef();s.current==null&&(s.current=uT({window:i,v5Compat:!0}));let o=s.current,[l,a]=I.useState({action:o.action,location:o.location}),{v7_startTransition:u}=r||{},h=I.useCallback(c=>{u&&a0?a0(()=>a(c)):a(c)},[a,u]);return I.useLayoutEffect(()=>o.listen(h),[o,h]),I.createElement(JT,{basename:e,children:n,location:l.location,navigationType:l.action,navigator:o,future:r})}const ok=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",lk=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,x2=I.forwardRef(function(e,n){let{onClick:r,relative:i,reloadDocument:s,replace:o,state:l,target:a,to:u,preventScrollReset:h,unstable_viewTransition:c}=e,d=ZT(e,nk),{basename:g}=I.useContext(Ar),m,w=!1;if(typeof u=="string"&&lk.test(u)&&(m=u,ok))try{let v=new URL(window.location.href),E=u.startsWith("//")?new URL(v.protocol+u):new URL(u),N=up(E.pathname,g);E.origin===v.origin&&N!=null?u=N+E.search+E.hash:w=!0}catch{}let T=MT(u,{relative:i}),p=ak(u,{replace:o,state:l,target:a,preventScrollReset:h,relative:i,unstable_viewTransition:c});function f(v){r&&r(v),v.defaultPrevented||p(v)}return I.createElement("a",Nd({},d,{href:m||T,onClick:w||s?r:f,ref:n,target:a}))});var u0;(function(t){t.UseScrollRestoration="useScrollRestoration",t.UseSubmit="useSubmit",t.UseSubmitFetcher="useSubmitFetcher",t.UseFetcher="useFetcher",t.useViewTransitionState="useViewTransitionState"})(u0||(u0={}));var c0;(function(t){t.UseFetcher="useFetcher",t.UseFetchers="useFetchers",t.UseScrollRestoration="useScrollRestoration"})(c0||(c0={}));function ak(t,e){let{target:n,replace:r,state:i,preventScrollReset:s,relative:o,unstable_viewTransition:l}=e===void 0?{}:e,a=Gu(),u=ul(),h=A2(t,{relative:o});return I.useCallback(c=>{if(tk(c,n)){c.preventDefault();let d=r!==void 0?r:Wa(u)===Wa(h);a(t,{replace:d,state:i,preventScrollReset:s,relative:o,unstable_viewTransition:l})}},[u,a,h,r,i,n,t,s,o,l])}var h0={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const XP=Math.log(2);class ZP{constructor(e){const n=s=>parseInt(Math.log(s)/XP,10),r=s=>parseInt(Array(s+1).join("1"),2);this.count=n(e+1),this.current_=this.count-1;const i=r(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const fu=function(t,e,n,r){t.sort(e);const i=function(a,u){const h=u-a;let c,d;if(h===0)return null;if(h===1)return c=t[a],d=n?n(c):c,new be(d,c.node,be.BLACK,null,null);{const g=parseInt(h/2,10)+a,m=i(a,g),w=i(g+1,u);return c=t[g],d=n?n(c):c,new be(d,c.node,be.BLACK,m,w)}},s=function(a){let u=null,h=null,c=t.length;const d=function(m,w){const T=c-m,p=c;c-=m;const f=i(T+1,p),v=t[T],E=n?n(v):v;g(new be(E,v.node,w,null,f))},g=function(m){u?(u.left=m,u=m):(h=m,u=m)};for(let m=0;m<a.count;++m){const w=a.nextBitIsOne(),T=Math.pow(2,a.count-(m+1));w?d(T,be.BLACK):(d(T,be.BLACK),d(T,be.RED))}return h},o=new ZP(t.length),l=s(o);return new mt(r||e,l)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
